...
export class ChapterTransition extends Scene {
  ...
  create(): void {
    ...
    const topLine = this.add.rectangle(
      screenWidth / 2,
      screenHeight / 2 - 120, // Moved higher
      lineWidth,
      2,
    ...
    const bottomLine = this.add.rectangle(
      screenWidth / 2,
      screenHeight / 2 + 250, // Moved significantly lower
      lineWidth,
      2,
      Phaser.Display.Color.HexStringToColor(colors.primary).color
    ).setOrigin(0.5).setScale(0, 1).setAlpha(0);
    ...
    const chapterTitle = this.add.text(
      screenWidth / 2,
      screenHeight / 2 - 20, // Moved up slightly
      chapterName,
      {
        fontFamily: "dungeon-mode",
        fontSize: "48px",
    ...
    const chapterSubtitle = this.add.text(
      screenWidth / 2,
      screenHeight / 2 + 30, // Tucked closer to title
      chapterSubtitleText,
      {
        fontFamily: "dungeon-mode",
        fontSize: "18px",
    ...
    const narrativeLabel = this.add.text(
      screenWidth / 2,
      screenHeight / 2 + 170, // Much lower to prevent overlap
      narrativeText,
      {
        fontFamily: "dungeon-mode",
        fontSize: "20px",
    ...
    narrativeLabel.setY(screenHeight / 2 + 200);
            ...
            this.tweens.add({
              ...
              onComplete: () => {
                ...
                this.tweens.add({
                  ...
                  alpha: 0.9,
                  y: screenHeight / 2 + 150, // slide to final position
                  duration: 1000,
                  ease: 'Power3.easeOut'
                });
