...
export class Phase6_StatusEffects extends TutorialPhase {
    ...
    private createAffinityExample(): Phaser.GameObjects.Container {
        ...
        const tikbalangEnemy = this.createTutorialEnemy('tikbalang_scout', 'tutorial_tikbalang_affinity');
        const affinityData = ElementalAffinitySystem.getAffinityDisplayData(tikbalangEnemy.elementalAffinity);
    ...
    private startBurnPractice(): void {
        const enemyData = this.createTutorialEnemy('tikbalang_scout', 'tutorial_tikbalang_burn');
    ...
    private performSpecialAction(): void {
        ...
        // Tikbalang Scout elemental affinity: weak to fire, resists air
        const mockEnemy = {
            elementalAffinity: { weakness: 'fire' as const, resistance: 'air' as const },
        };
