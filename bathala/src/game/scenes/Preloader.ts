...
export class Preloader extends Scene {
  ...
  preload() {
    ...
    this.load.image("sirena_overworld", "sprites/combat/enemy/chapter2/sirena_battle.png");
    this.load.image("siyokoy_overworld", "sprites/combat/enemy/chapter2/siyokoy_battle.png");
    this.load.image("santelmo_overworld", "sprites/combat/enemy/chapter2/santelmo_battle.png");
    this.load.image("berberoka_overworld", "sprites/combat/enemy/chapter2/berberoka_battle.png");
    this.load.image("magindara_overworld", "sprites/combat/enemy/chapter2/magindara_battle.png");
    this.load.image("kataw_overworld", "sprites/combat/enemy/chapter2/kataw_battle.png");
    this.load.image("berbalang_overworld", "sprites/combat/enemy/chapter2/berbalang_battle.png");
    this.load.image("sunkenbangkilan_overworld", "sprites/combat/enemy/chapter2/bangkilan_battle.png");
    this.load.image("apoytubig_overworld", "sprites/combat/enemy/chapter2/apoy_tubig_battle.png");
    ...
    this.load.image("tigmamanukan_overworld", "sprites/combat/enemy/chapter3/tigmanukan_battle.png");
    this.load.image("diwata_overworld", "sprites/combat/enemy/chapter3/diwata_battle.png");
    this.load.image("sarimanok_overworld", "sprites/combat/enemy/chapter3/sarimanok_battle.png");
    this.load.image("bulalakaw_overworld", "sprites/combat/enemy/chapter3/bulalakaw_battle.png");
    this.load.image("minokawa_overworld", "sprites/combat/enemy/chapter3/minokawa_battle.png");
    this.load.image("alan_overworld", "sprites/combat/enemy/chapter3/alan_battle.png");
    this.load.image("ekek_overworld", "sprites/combat/enemy/chapter3/ekek_battle.png");
    this.load.image("ribunglinti_overworld", "sprites/combat/enemy/chapter3/ribung_linti_battle.png");
    this.load.image("apolaki_overworld", "sprites/combat/enemy/chapter3/apolaki_battle.png");
