/**
 * DelaunayMazeChunkAdapter — IChunkGenerator for Delaunay triangulation corridors.
 *
 * This is the CHUNK ADAPTER for the Delaunay Maze terrain pipeline.
 ...
 *
 * @module DelaunayMazeChunkAdapter
 */
...
export class DelaunayMazeChunkAdapter implements IChunkGenerator {
...
/** @deprecated Use `DelaunayMazeChunkAdapter` instead. */
export const DelaunayMazeChunkGenerator = DelaunayMazeChunkAdapter;
