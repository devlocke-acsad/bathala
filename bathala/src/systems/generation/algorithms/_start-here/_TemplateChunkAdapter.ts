/**
 * _TemplateChunkAdapter — Copy and rename this file when creating a new algorithm.
 *
 * TEMPLATE NOTICE:
 ...
 *
 * This is the CHUNK ADAPTER layer. It:
 ...
 *   [LevelName]ChunkAdapter.ts  — Chunk Adapter (this file)
 *
 * After creating both files:
 *   1. Export your chunk adapter from `algorithms/index.ts`
 *   2. Return it from your ActDefinition.createGenerator()
 *
 * @module _TemplateChunkAdapter
 */
...
export class _TemplateChunkAdapter implements IChunkGenerator {
    readonly name = '_template'; // ← Change this to your level name
    readonly chunkSize: number;
...
/** @deprecated Use `_TemplateChunkAdapter` instead. */
export const _TemplateChunkGenerator = _TemplateChunkAdapter;
