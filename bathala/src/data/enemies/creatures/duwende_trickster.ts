...
export const DUWENDE_TRICKSTER: EnemyConfig = {
  ...
  // === Dialogue ===
  dialogue: {
    intro: 'Tabi-tabi po! Ha! You forgot to ask permission before stepping on my mound, mortal! The old ones knew to whisper those words — but politeness means nothing now that the engkanto have taught us new tricks. My mischief has teeth!',
