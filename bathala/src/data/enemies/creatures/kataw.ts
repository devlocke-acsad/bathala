...
export const KATAW: EnemyConfig = {
  ...
  // === Dialogue ===
  dialogue: {
    intro: 'The seas bow to my rule, surfacer! I am kataw — half-human, half-fish, king of the Bisaya waters! My domain stretches from the shallows where children play to the abyssal trenches where light fears to go. The engkanto promised me dominion over ALL waters. What king refuses a larger kingdom?',
