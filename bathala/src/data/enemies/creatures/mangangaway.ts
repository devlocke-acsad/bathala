...
export const MANGANGAWAY: EnemyConfig = {
  ...
  // === Dialogue ===
  dialogue: {
    intro: "Fates reverse at MY command! Each skull was a patient I could not save — then the engkanto whispered: 'Why heal when you can hex?' Every prayer I learned, I now speak BACKWARDS!",
