...
export const MINOKAWA_HARBINGER: EnemyConfig = {
  ...
  // === Dialogue ===
  dialogue: {
    intro: 'ECLIPSES DEVOUR THE LIGHT! I am the Minokawa — bird of the Bagobo people, so vast that my wings span the sky from horizon to horizon! When I swallow the sun, the world goes dark. When I swallow the moon, the tides go mad. The engkanto said: \'Why stop at sun and moon? Swallow HOPE itself!\'',
