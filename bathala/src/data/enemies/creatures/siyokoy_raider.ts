...
export const SIYOKOY_RAIDER: EnemyConfig = {
  ...
  // === Dialogue ===
  dialogue: {
    intro: 'These scales are the weight of the drowned! I am siyokoy — the engkanto promised every soul I drag down would free my own. LIES — but the dragging feels true!',
