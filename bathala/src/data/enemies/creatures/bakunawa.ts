...
export const BAKUNAWA: EnemyConfig = {
  ...
  // === Dialogue ===
  dialogue: {
    intro: 'SEVEN MOONS I devoured! The engkanto promised freedom for each — but the chains only multiplied! I am the Bakunawa, and my hunger has become the sea itself!',
