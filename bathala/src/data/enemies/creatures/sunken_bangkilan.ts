...
export const SUNKEN_BANGKILAN: EnemyConfig = {
  ...
  // === Dialogue ===
  dialogue: {
    intro: 'Curses bubble from the abyss where the sunken barangays lie! I am the bangkilan — sorceress of the drowned villages, shape-shifter of a hundred stolen faces. The mangkukulam of the land cast curses with herbs and dolls. I cast mine with the bones of ships and the tears of widows. The engkanto gave me the faces of the dead. Shall I wear YOURS?',
