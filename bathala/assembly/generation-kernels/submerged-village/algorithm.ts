// @ts-nocheck
/**
 * Main pipeline — generateSubmergedVillage().
 *
 * Single exported function that runs the entire village generation in WASM.
...
export function generateSubmergedVillage(width: i32, height: i32, seed: i32): void {
